...
use Illuminate\Support\Str; // Verifique se esta linha está presente
...
class CommunityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Community::create([
            'user_id' => Auth::id(),
            'name' => $validated['name'],
            'slug' => Str::slug($validated['name']), // A linha crucial
    ...
    {
        $posts = $community->posts()->latest()->orderBy('is_pinned', 'desc')->paginate(10);
